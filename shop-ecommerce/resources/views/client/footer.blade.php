<footer class="bg3 p-t-75 p-b-32">
    <div class="container">
        <div class="row">
            <div class="col-sm-3 col-lg-4 p-b-50">
            ...
            <div class="col-sm-3 col-lg-4 p-b-50">
                ...
                <ul>
                    ...
                    <li class="p-b-10">
                        <a href="{{Route('home.products')}}" class="stext-107 cl7 hov-cl1 trans-04">
                            Cửa Hàng 
                        </a>
                    </li>

                    <li class="p-b-10">
                        <a href="{{Route('home.about')}}" class="stext-107 cl7 hov-cl1 trans-04">
                            Về Cửa Hàng
                        </a>
                    </li>
